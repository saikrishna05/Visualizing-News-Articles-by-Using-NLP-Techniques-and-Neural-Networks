...
ArrayList<Integer> per = new ArrayList<Integer>();
	...
	//	System.out.println(checkners);
		...
		System.out.println("Articles Score based on My Recommendation Algorithm..!");
    	...
    	for(int j=0;j<2;j++) {
    			...
    			p=titles.indexOf(checkners.get(nou.get(i)+j));
    			System.out.println("Title : "+titles.get(p+1+j)+"\n");    
    			outputWriter.write("Title : ");
    			outputWriter.write(titles.get(p+1+j));
    			outputWriter.newLine();
    			outputWriter.newLine();
    			
    			p=txts.indexOf(checkners.get(nou.get(i)+j));
    			System.out.println(txts.get(p+1+j)+"\n");
    			outputWriter.write(txts.get(p+1+j));
    			outputWriter.newLine();
    			outputWriter.newLine();
    			
    			p=urls.indexOf(checkners.get(nou.get(i)+j));
    			System.out.println("Link :  "+urls.get(p+1+j)+"\n");
    			outputWriter.write("Link :  ");
    			outputWriter.write(urls.get(p+1+j));
    			outputWriter.newLine();
    			outputWriter.newLine();
    			}
